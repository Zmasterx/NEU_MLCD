...
def get_config():
    ...
    parser.add_argument('--model_name', type=str, default='Resnet50',
                        choices=['GoogleNet', 'Nin', 'ResNet18', 'Resnet50', 'Resnet101'])
    parser.add_argument('--TP', type=str, default='predict')
    ...
    parser.add_argument('--index', type=int, default=0) #这个index是啥含义
