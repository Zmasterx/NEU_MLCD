            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        center_x = (xyxy[0] + xyxy[2]) / 2 + 518
                        center_y = (xyxy[1] + xyxy[3]) / 2 + 33
                        # 打印边界框中心位置信息到控制台
                        print(f"Center of bounding box {names[int(cls)]}: ({center_x}, {center_y})")
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/AAtask3.yaml', help='(optional) dataset.yaml path')
